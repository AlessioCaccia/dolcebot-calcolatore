<script>
    ...
    $: pm_comm = (fatturato - ota - pulizie) * 0.30;
...
<div class="input-grid">
    <div class="input-group">
        ...
        <input type="number" id="fatturato" bind:value={fatturato} placeholder="Es. 30000" />
    </div>

    <div class="input-group">
        <label for="costoPulizia">Costo singola pulizia (€)</label>
        <input type="number" id="costoPulizia" bind:value={costoPulizia} placeholder="Es. 50" />
    </div>

    <div class="input-group">
        <label for="checkIn">Numero check-in annuali</label>
        <input type="number" id="checkIn" bind:value={checkIn} placeholder="Es. 40" />
    </div>
...
<div class="main-container">
    <div class="grid-container">
        <div class="grid-header-cell other-header"></div>
        <div class="grid-header-cell"><img src="https://placehold.co/100x30/000000/FFFFFF?text=DolceBot"
                alt="DolceBot Logo" class="dolcebot-logo"></div>
        ...
        <div class="grid-data-cell net-profit-row-item">{auto_netto.toFixed(2)}</div>
